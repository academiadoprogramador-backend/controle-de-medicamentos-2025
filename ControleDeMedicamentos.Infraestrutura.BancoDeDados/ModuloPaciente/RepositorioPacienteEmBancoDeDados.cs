...
namespace ControleDeMedicamentos.Infraestrutura.BancoDeDados.ModuloPaciente;

public class RepositorioPacienteEmBancoDeDados(IDbConnection connection) : IRepositorioPaciente
{
